...
// single_dists_tr
Rcpp::List single_dists_tr(const Rcpp::List& mat_list, const Rcpp::LogicalVector& tr_vec, const double& tr_inp);
RcppExport SEXP _smile_single_dists_tr(SEXP mat_listSEXP, SEXP tr_vecSEXP, SEXP tr_inpSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::List& >::type mat_list(mat_listSEXP);
    Rcpp::traits::input_parameter< const Rcpp::LogicalVector& >::type tr_vec(tr_vecSEXP);
