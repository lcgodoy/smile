...
estimates, we need to use the function `sai_var` (see the chunk of code
below). The function is quite similar to the before mentioned `sai`. The
...
the `sai_var` function is the `target` (`sf data.frame`) with two additional
