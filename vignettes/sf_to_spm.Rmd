...
grid of 732 points (multiple of the number of polygons observed). The "sparsity"
...
```{R sf-to-spm2, echo = FALSE}
set.seed(123)

msoa_spm1 <-
    sf_to_spm(sf_obj1 = liv_msoa, n_pts = 732,
...
msoa_spm4 <-
    sf_to_spm(sf_obj1 = liv_msoa, n_pts = 732/61,
...
rm(list = ls(pattern = "^msoa_spm")); gc(verbose = FALSE, full = TRUE)
